...
class Preprocessor:
    ...
    def replaceInvalidValuesWithNull(self, data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Exited the replaceInvalidValuesWithNull method of the Preprocessor class\n')
            return data
        except Exception as e:
            self.logger_object.log(self.file_object, 'Exception occurred in replaceInvalidValuesWithNull method of the Preprocessor class. Exception:  '+str(e))
            self.logger_object.log(self.file_object, 'Exited the replaceInvalidValuesWithNull method of the Preprocessor class')
            raise Exception()